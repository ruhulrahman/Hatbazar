                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">
							User Managing Section || Electronics Posts
                        </h2>
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Electronics Post Lists</h3>
                            </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php
                                        if(isset($getProductBySearch)){
                                            $getProductBySearch = $ec->getProductBySearch($productName);
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><img width="50" height="50" src="../<?php echo $result['image'];?>" alt=""></td>
                                                <td class="text-center"><?php echo $result['post_title'];?></td>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-primary" href="edit_user_post.php?PostId=<?php echo $result['electId'];?>">Edit</a> ||
                                                    <a class="btn btn-danger" href="?DeleteId=<?php echo $result['electId'];?>">Delete</a>
                                                </td>
                                            </tr>     
                                    ...
                                    <?php       }
                                                ...
                                                $getAllEllectPro = $ec->getAllElectProductWithUserId();
                                                $i = 0;
                                                if($getAllEllectPro){
                                                while ($result = $getAllEllectPro->fetch_assoc()) { 
                                                    $i++;
                                                    ?>
